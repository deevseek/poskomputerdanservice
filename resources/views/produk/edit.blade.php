    ...
    <form class="grid gap-6 md:grid-cols-2">
        <div class="space-y-4">
            <div>
                ...
                <input type="text" value="Laptop Unggulan" class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 dark:border-slate-700 dark:bg-slate-900" />
            </div>
            <div>
                <label class="text-sm font-semibold">SKU</label>
                <input type="text" value="SKU0099" class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 dark:border-slate-700 dark:bg-slate-900" />
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="number" value="8500000" class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 dark:border-slate-700 dark:bg-slate-900" />
                </div>
                <div>
                    <label class="text-sm font-semibold">Harga Jual</label>
                    <input type="number" value="10500000" class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 dark:border-slate-700 dark:bg-slate-900" />
                </div>
            </div>
            <div>
                <label class="text-sm font-semibold">Stok</label>
                <input type="number" value="12" class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 dark:border-slate-700 dark:bg-slate-900" />
            </div>
        </div>
        <div class="space-y-4">
            <div>
                <label class="text-sm font-semibold">Keterangan</label>
                <textarea rows="5" class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 dark:border-slate-700 dark:bg-slate-900">Laptop premium dengan garansi 2 tahun.</textarea>
            </div>
            <div>
                ...
                <div class="mt-2 flex items-center gap-4 rounded-xl border border-dashed border-slate-300 bg-slate-50 px-4 py-5 text-sm text-slate-500 dark:border-slate-700 dark:bg-slate-900">
                    ...
                    <div>
                        <p class="font-semibold text-slate-700 dark:text-slate-200">Unggah gambar baru</p>
                ...
                <div class="mt-2 h-32 w-full overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-900">
                    <img src="https://source.unsplash.com/400x300/?laptop" class="h-full w-full object-cover" alt="preview" />
                </div>
            </div>
            <div class="flex justify-end gap-3">
                ...
                <button class="rounded-xl bg-primary px-5 py-2 text-sm font-semibold text-white shadow hover:bg-primary/90">Simpan Perubahan</button>
            </div>
        </div>
    </form>
</div>
